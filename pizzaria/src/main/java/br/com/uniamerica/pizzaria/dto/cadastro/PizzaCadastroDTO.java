...
public class PizzaCadastroDTO {
    ...
    public PizzaCadastroDTO(Pizza pizza){
        id = pizza.getId();
        ativo = pizza.isAtivo();
    ...
    public PizzaCadastroDTO(Long id, boolean ativo, LocalDateTime registro, List<Sabor> sabor, Tamanho tamanho, BigDecimal valorPizza, int qtdeSabor){
        this.id = id;
        this.ativo = ativo;
